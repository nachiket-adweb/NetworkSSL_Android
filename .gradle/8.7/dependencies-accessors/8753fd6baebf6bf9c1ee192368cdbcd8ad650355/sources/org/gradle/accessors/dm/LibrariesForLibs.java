...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class FuelLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
         ...
         * with version reference <b>fuel</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> asProvider() {
    ...
    public static class MultiplatformLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>crypto</b> with <b>com.ionspin.kotlin:multiplatform-crypto</b> coordinates and
         * with version reference <b>multiplatformCrypto</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getCrypto() {
            return create("multiplatform.crypto");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>fuel</b> with value <b>2.3.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>multiplatformCrypto</b> with value <b>0.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getMultiplatformCrypto() { return getVersion("multiplatformCrypto"); }
        ...
        /**
         * Version alias <b>uiTooling</b> with value <b>1.5.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class KotlinVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        private final KotlinCryptoVersionAccessors vaccForKotlinCryptoVersionAccessors = new KotlinCryptoVersionAccessors(providers, config);
        ...
        /**
         * Group of versions at <b>versions.kotlin.crypto</b>
         */
        public KotlinCryptoVersionAccessors getCrypto() {
            return vaccForKotlinCryptoVersionAccessors;
        }

    }

    public static class KotlinCryptoVersionAccessors extends VersionFactory  {

        public KotlinCryptoVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>kotlin.crypto.ver</b> with value <b>0.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getVer() { return getVersion("kotlin.crypto.ver"); }
